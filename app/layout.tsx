...
export const metadata = {
  title: 'Ananya Das | Personal Portfolio',
  description: 'Ananya is a Software DevOps Engineer with 5 years of experience',
}
  ...
  return (
    <html lang="en">
      <body className={`${inter.className}bg-gray-50 text-gray-950 relative h-[5000px]`}>
        <div className="bg-[#e38f65] absolute top-[-6rem] 
        -z-10 right[-11rem] h-[31.25rem] w-[31.25rem] 
        rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
        <div className="bg-[#dbf4e3] absolute top-[-1rem] 
        -z-10 left[-35rem] h-[31.25rem] w-[50rem] 
